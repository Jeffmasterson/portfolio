...
import { getPostBySlug, getRecentPosts, getRelatedPosts, postPathBySlug } from 'lib/websites';
...
export async function getStaticProps({ params = {} } = {}) {
  ...
  const { categories, databaseId: databaseId } = post;
  ...
  const { category: relatedCategory, posts: relatedPosts } = (await getRelatedPosts(categories, databaseId)) || {};
